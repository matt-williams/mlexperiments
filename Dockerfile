...
RUN pip3 install --no-cache-dir pandas scipy matplotlib ipython jupyter jupyterlab sympy nose seaborn opencv-python scikit-image torchvision tqdm librosa oblige vizdoom
